...
namespace API.Controllers
{
    public class PedidoController : BaseController
    {
        ...
        public async Task<ActionResult<IEnumerable<PedidoDto>>> Get()
        {
            ...
            return _mapper.Map<List<PedidoDto>>(entity);
        }
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<Pedido>> Post(PedidoDto entityDto)
        {
            var entity = _mapper.Map<Pedido>(entityDto);
        /*
        ...
        */
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<PedidoDto>> Put(int id, [FromBody] PedidoDto entityDto)
        {
            var entity = _mapper.Map<Pedido>(entityDto);
            if (entity.Id == 0)
            {
