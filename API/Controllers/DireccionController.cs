...
namespace API.Controllers
{
    public class DireccionController : BaseController
    {
        ...
        {
            var entity = await _unitOfWork.Direcciones.GetAllAsync();
            return _mapper.Map<List<DireccionDto>>(entity);
        }
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<Direccion>> Post(DireccionDto entityDto)
        {
            var entity = _mapper.Map<Direccion>(entityDto);
        /*
        ...
        */
            _unitOfWork.Direcciones.Add(entity);
        ...
        {
            var entity = await _unitOfWork.Direcciones.GetByIdAsync(id);
            if (entity == null)
            {
                return NotFound();
            }
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<DireccionDto>> Put(int id, [FromBody] DireccionDto entityDto)
        {
            var entity = _mapper.Map<Direccion>(entityDto);
            if (entity.Id == 0)
            {
        ...
        */
            entityDto.Id = entity.Id;
            _unitOfWork.Direcciones.Update(entity);
            await _unitOfWork.SaveAsync();
            return entityDto;
        }
        [HttpDelete("{id}")]
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            _unitOfWork.Direcciones.Remove(entity);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
