...
namespace API.Controllers
{
    public class ColorController : BaseController
    {
        ...
        {
            var entity = await _unitOfWork.Colores.GetAllAsync();
            return _mapper.Map<List<ColorDto>>(entity);
        }
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<Color>> Post(ColorDto entityDto)
        {
            var entity = _mapper.Map<Color>(entityDto);
        /*
        ...
        */
            _unitOfWork.Colores.Add(entity);
        ...
        {
            var entity = await _unitOfWork.Colores.GetByIdAsync(id);
            if (entity == null)
            {
                return NotFound();
            }
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<ColorDto>> Put(int id, [FromBody] ColorDto entityDto)
        {
            var entity = _mapper.Map<Color>(entityDto);
            if (entity.Id == 0)
            {
        ...
        */
            entityDto.Id = entity.Id;
            _unitOfWork.Colores.Update(entity);
            await _unitOfWork.SaveAsync();
            return entityDto;
        }
        [HttpDelete("{id}")]
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            _unitOfWork.Colores.Remove(entity);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
